...
| train_s_fixedholes.json, val_s_fixedholes.json |   s    | Sim data from Unity11k urban with fixed holes in the ground + Unity suburban dataset without fences |  Alexia   |
