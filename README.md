...
| :--------------------------------------- | :----: | :-------------------------------------- | :----: |
| train_r_full_pl.json, val_r_full_pl.json |   r    | MegaDepth + Segmentation pseudo-labels (HRNet + Cityscapes) | Alexia |
...
## Training/resumeing with/without ADVENT V2 automatically
